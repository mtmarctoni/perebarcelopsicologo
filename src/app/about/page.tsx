        ...
        <main className="pb-12">
          ...
          <SectionContainer className="">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2 space-y-6">
                <span className="text-secondary text-sm font-semibold uppercase tracking-widest">Mi historia</span>
                <h2 className="text-4xl font-bold text-text-dark tracking-tight">
                  ¿Quién soy?
                </h2>
          ...
          <SectionContainer className="bg-background-alt/50">
            <div className="text-center mb-12">
              <span className="text-secondary text-sm font-semibold uppercase tracking-widest">Fortalezas</span>
              <h2 className="text-4xl font-bold text-text-dark mt-3 tracking-tight">¿Por qué elegirme?</h2>
            </div>
          ...
          <SectionContainer className="">
            <div className="bg-background rounded-3xl shadow-card p-8 sm:p-12">
              <span className="text-secondary text-sm font-semibold uppercase tracking-widest">Trayectoria</span>
          ...
          <SectionContainer className="bg-background-alt/50">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-text-dark mt-3 mb-8 tracking-tight">Mi compromiso</h2>
              <p className="text-text text-lg leading-relaxed">
