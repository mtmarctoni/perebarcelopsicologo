...
import { performanceCards } from "@/utils/cards";
        ...
        <SectionContainer className="">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-text text-lg leading-relaxed">
              El rendimiento es la capacidad de obtener los mejores resultados con el menor uso de
              recursos posible. El rendimiento deportivo se sustenta en 4 pilares: la técnica, la
              táctica, la preparación física y la preparación psicológica.
            </p>
          </div>
        </SectionContainer>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-background rounded-3xl shadow-card p-8 sm:p-12">
              ...
              <div className="space-y-4 text-text text-lg leading-relaxed">
                <p>
                  La psicología deportiva desempeña un papel crucial en el rendimiento deportivo, ya
                  que aborda los aspectos mentales y emocionales que influyen directamente en la
                  ejecución y los resultados.
                </p>
                <p>
                  A través de técnicas como el manejo del estrés, la mejora de la concentración, el
                  fortalecimiento de la autoconfianza y la regulación emocional, los atletas pueden
                  optimizar su desempeño bajo presión y mantener una mentalidad positiva.
                </p>
              </div>
            </div>
          </div>
