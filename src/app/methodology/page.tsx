...
import { methodologyCards } from "@/utils/cards";
        ...
        <SectionContainer className="">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-4 text-text text-lg leading-relaxed">
              <p>
                Mi enfoque de trabajo se fundamenta en una serie de principios que buscan integrar
                la teoría con la práctica, siempre con el objetivo de maximizar el rendimiento y la
                eficacia en el deporte.
              </p>
              <p>
                El primer principio que rige mi metodología es la personalización del entrenamiento.
                Cada atleta es único y, por lo tanto, requiere un enfoque adaptado a sus
                características, habilidades y metas.
              </p>
            </div>
          </div>
        </SectionContainer>
        ...
        <SectionContainer className="">
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="bg-background rounded-3xl shadow-card p-8 sm:p-12">
              ...
              <div className="space-y-4 text-text text-lg leading-relaxed">
                <p>
                  Durante la sesión, se realizan evaluaciones de las necesidades individuales, lo
                  que permite ajustar el enfoque y las técnicas que se utilizarán.
                </p>
                <p>
                  Los participantes tienen la flexibilidad de asistir desde cualquier lugar, lo que
                  facilita la integración de estas sesiones en sus rutinas habituales.
                </p>
              </div>
            ...
            <div className="bg-background rounded-3xl shadow-card p-8 sm:p-12">
              ...
              <div className="space-y-4 text-text text-lg leading-relaxed">
                <p>
                  Los talleres diseñados para los clubes están orientados a fortalecer las
                  habilidades tanto de los deportistas como de los entrenadores y padres.
                </p>
                <p>
                  La observación de entrenamientos permite una mirada objetiva sobre la dinámica del
                  equipo, identificando patrones de comportamiento y áreas de mejora.
                </p>
              </div>
            </div>
          </div>
