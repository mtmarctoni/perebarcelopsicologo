...
export default function ContactHeroSection() {
  ...
  return (
    <section className="relative bg-background overflow-hidden">
      ...
      <div className="absolute top-0 left-[30%] w-px h-full bg-linear-to-b from-transparent via-white/5 to-transparent" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 lg:py-32">
        <Reveal trigger="load" stagger={0.12} className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-6 text-lg sm:text-xl text-text-light leading-relaxed">{t("subtitle")}</p>
        </Reveal>
      </div>
    </section>
  );
