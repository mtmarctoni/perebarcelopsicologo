            ...
            >
              {benefits.map((text) => (
                <m.div
                  key={text}
                  variants={fadeInUp}
                  className="flex flex-col items-center text-center sm:flex-row sm:items-start sm:text-left gap-5 p-6 rounded-2xl bg-background-alt border border-border shadow-xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 group"
                >
