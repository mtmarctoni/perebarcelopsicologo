  ...
  return (
    <section className="relative bg-background overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 lg:py-32">
        ...
        <Reveal stagger={0.12} className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {topics.map((item) => (
            <div
              key={item.icon}
              className="p-8 rounded-2xl bg-background-alt border border-border shadow-xs hover:shadow-md hover:-translate-y-1 transition-[box-shadow,transform] duration-300 group"
            >
