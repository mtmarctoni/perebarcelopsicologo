      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 lg:py-32">
        ...
        >
          {painPoints.map((item) => (
            <div
              key={item.num}
              className="group relative bg-card border border-border rounded-2xl p-7 lg:p-8 hover:bg-card-hover hover:border-secondary/30 hover:-translate-y-1 transition-[background-color,border-color,transform] duration-500"
            >
